    ...
    <section className="py-16 bg-[color:var(--primary)] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 items-center">
          {/* Left Column - Title, Rating and Note */}
          <div className="lg:w-1/3 text-white stagger-item" style={isMounted ? { ...visibleStaggerStyle, transitionDelay: '0.1s' } : initialStaggerStyle}>
          ...
          <div className="lg:w-2/3 stagger-item" style={isMounted ? { ...visibleStaggerStyle, transitionDelay: '0.3s' } : initialStaggerStyle}>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 card-shadow border border-white/20">
              <Swiper
              ...
              >
                {reviews.map((review, index) => (
                  <SwiperSlide key={index}>
                    <div className="bg-white rounded-xl p-5 shadow-md h-full flex flex-col justify-between">
                      <div>
